...
namespace Optifine.Xdelta {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='optifine.xdelta']/class[@name='ByteArraySeekableSource']"
	[global::Android.Runtime.Register ("optifine/xdelta/ByteArraySeekableSource", DoNotGenerateAcw=true)]
	public partial class ByteArraySeekableSource : global::Java.Lang.Object, global::Optifine.Xdelta.ISeekableSource {
		static readonly JniPeerMembers _members = new XAPeerMembers ("optifine/xdelta/ByteArraySeekableSource", typeof (ByteArraySeekableSource));
		...
		protected ByteArraySeekableSource (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='optifine.xdelta']/class[@name='ByteArraySeekableSource']/constructor[@name='ByteArraySeekableSource' and count(parameter)=1 and parameter[1][@type='byte[]']]"
		[Register (".ctor", "([B)V", "")]
		public unsafe ByteArraySeekableSource (byte[]? source) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Optifine.Xdelta.ByteArraySeekableSource> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
			__this.Close ();
		}
#pragma warning restore 0169

		// Metadata.xml XPath method reference: path="/api/package[@name='optifine.xdelta']/class[@name='ByteArraySeekableSource']/method[@name='close' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='optifine.xdelta']/class[@name='ByteArraySeekableSource']/method[@name='length' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='optifine.xdelta']/class[@name='ByteArraySeekableSource']/method[@name='read' and count(parameter)=3 and parameter[1][@type='byte[]'] and parameter[2][@type='int'] and parameter[3][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='optifine.xdelta']/class[@name='ByteArraySeekableSource']/method[@name='seek' and count(parameter)=1 and parameter[1][@type='long']]"
