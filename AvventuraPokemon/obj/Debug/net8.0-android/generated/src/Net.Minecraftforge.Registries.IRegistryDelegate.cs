...
namespace Net.Minecraftforge.Registries {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='net.minecraftforge.registries']/interface[@name='IRegistryDelegate']"
	[Register ("net/minecraftforge/registries/IRegistryDelegate", "", "Net.Minecraftforge.Registries.IRegistryDelegateInvoker")]
	[global::Java.Interop.JavaTypeParameters (new string [] {"T"})]
	public partial interface IRegistryDelegate : IJavaObject, IJavaPeerable {
		// Metadata.xml XPath method reference: path="/api/package[@name='net.minecraftforge.registries']/interface[@name='IRegistryDelegate']/method[@name='get' and count(parameter)=0]"
		[Register ("get", "()Ljava/lang/Object;", "GetGetHandler:Net.Minecraftforge.Registries.IRegistryDelegateInvoker, AvventuraPokemon")]
		global::Java.Lang.Object? Get ();

		// Metadata.xml XPath method reference: path="/api/package[@name='net.minecraftforge.registries']/interface[@name='IRegistryDelegate']/method[@name='type' and count(parameter)=0]"
		[Register ("type", "()Ljava/lang/Class;", "GetTypeHandler:Net.Minecraftforge.Registries.IRegistryDelegateInvoker, AvventuraPokemon")]
		global::Java.Lang.Class? Type ();

	}

	[global::Android.Runtime.Register ("net/minecraftforge/registries/IRegistryDelegate", DoNotGenerateAcw=true)]
	internal partial class IRegistryDelegateInvoker : global::Java.Lang.Object, IRegistryDelegate {
		static readonly JniPeerMembers _members = new XAPeerMembers ("net/minecraftforge/registries/IRegistryDelegate", typeof (IRegistryDelegateInvoker));
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException ($"Unable to convert instance of type '{JNIEnv.GetClassNameFromInstance (handle)}' to type 'net.minecraftforge.registries.IRegistryDelegate'.");
			return handle;
		}
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Net.Minecraftforge.Registries.IRegistryDelegate> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
