...
namespace Net.Optifine.Shaders.Config {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='net.optifine.shaders.config']/class[@name='HeaderLineVariable']"
	[global::Android.Runtime.Register ("net/optifine/shaders/config/HeaderLineVariable", DoNotGenerateAcw=true)]
	public partial class HeaderLineVariable : global::Net.Optifine.Shaders.Config.HeaderLine {
		static readonly JniPeerMembers _members = new XAPeerMembers ("net/optifine/shaders/config/HeaderLineVariable", typeof (HeaderLineVariable));
		...
		protected HeaderLineVariable (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='net.optifine.shaders.config']/class[@name='HeaderLineVariable']/constructor[@name='HeaderLineVariable' and count(parameter)=3 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", "")]
		public unsafe HeaderLineVariable (string? qualifier, string? name, string? text) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			IntPtr native_qualifier = JNIEnv.NewString ((string?)qualifier);
			IntPtr native_name = JNIEnv.NewString ((string?)name);
			IntPtr native_text = JNIEnv.NewString ((string?)text);
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [3];
				__args [0] = new JniArgumentValue (native_qualifier);
				...
				JNIEnv.DeleteLocalRef (native_qualifier);
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Net.Optifine.Shaders.Config.HeaderLineVariable> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
			return JNIEnv.NewString (__this.Text);
		}
#pragma warning restore 0169

		public override unsafe string? Text {
			// Metadata.xml XPath method reference: path="/api/package[@name='net.optifine.shaders.config']/class[@name='HeaderLineVariable']/method[@name='getText' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='net.optifine.shaders.config']/class[@name='HeaderLineVariable']/method[@name='matches' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='net.optifine.shaders.config']/class[@name='HeaderLineVariable']/method[@name='removeFrom' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
