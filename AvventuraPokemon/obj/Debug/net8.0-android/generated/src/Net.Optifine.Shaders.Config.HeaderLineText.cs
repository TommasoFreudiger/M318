...
namespace Net.Optifine.Shaders.Config {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='net.optifine.shaders.config']/class[@name='HeaderLineText']"
	[global::Android.Runtime.Register ("net/optifine/shaders/config/HeaderLineText", DoNotGenerateAcw=true)]
	public partial class HeaderLineText : global::Net.Optifine.Shaders.Config.HeaderLine {
		static readonly JniPeerMembers _members = new XAPeerMembers ("net/optifine/shaders/config/HeaderLineText", typeof (HeaderLineText));
		...
		protected HeaderLineText (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='net.optifine.shaders.config']/class[@name='HeaderLineText']/constructor[@name='HeaderLineText' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;)V", "")]
		public unsafe HeaderLineText (string? text) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Net.Optifine.Shaders.Config.HeaderLineText> (jnienv, native__this, JniHandleOwnership.DoNotTransfer)!;
			return JNIEnv.NewString (__this.Text);
		}
#pragma warning restore 0169

		public override unsafe string? Text {
			// Metadata.xml XPath method reference: path="/api/package[@name='net.optifine.shaders.config']/class[@name='HeaderLineText']/method[@name='getText' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='net.optifine.shaders.config']/class[@name='HeaderLineText']/method[@name='matches' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='net.optifine.shaders.config']/class[@name='HeaderLineText']/method[@name='removeFrom' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
